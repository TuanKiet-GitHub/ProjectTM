    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         ...
         string secretKey = "UKnz2ype9MTCKNZqH2wbFcxS1Vph7ncx";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ThapMuoi.WebAPI", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "KhuCumCongNghiep.WebAPI v1"));
            }
